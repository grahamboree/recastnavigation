...
{
	switch (static_cast<SamplePolyAreas>(area))
	{
		// Ground (0) : light blue
	case SamplePolyAreas::SAMPLE_POLYAREA_GROUND:
		return duRGBA(0, 192, 255, 255);
		// Water : blue
	case SamplePolyAreas::SAMPLE_POLYAREA_WATER:
		return duRGBA(0, 0, 255, 255);
		// Road : brown
	case SamplePolyAreas::SAMPLE_POLYAREA_ROAD:
		return duRGBA(50, 20, 12, 255);
		// Door : cyan
	case SamplePolyAreas::SAMPLE_POLYAREA_DOOR:
		return duRGBA(0, 255, 255, 255);
		// Grass : green
	case SamplePolyAreas::SAMPLE_POLYAREA_GRASS:
		return duRGBA(0, 255, 0, 255);
		// Jump : yellow
	case SamplePolyAreas::SAMPLE_POLYAREA_JUMP:
